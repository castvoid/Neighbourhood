...
@-moz-keyframes pulsate { 
    0% { background: rgba(0,255,0,0.4) !important }
    50% { background: rgba(0,100,0,0.4) !important }
    100% { background: rgba(0,255,0,0.4) !important }
}
h1 {
    font-size: 70px;
    position: absolute;
...
table#regions tr td:last-child { border-right: none }
td {
...
.continue:not(.nosave) {
    cursor:  pointer;
    -moz-animation: pulsate 2s infinite !important;
