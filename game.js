var map, addP, json, selected = -1,
    ...
    function initialize() {
        ...
        function (data) {
            ...
            for (i=0;i<=11;i++) {
				if ($.inArray(i, player.controlOf) != -1) {
