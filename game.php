	...
	<div id="sidebar">
		<div id="profile">
			<ul>
                ...
                <li><a href="javascript:locationdivexpand();">Show</a> - <a href="javascript:locationdivshrink();">Hide</a></li>
				<li><div id="expandinglocationdiv"><i class="icon-map-marker icon-large tip" title="Locations you own"></i> <span id="currentregions">0</span></div></li>
			</ul>
		</div>
